		...
		return (
			<div className= "leftnav">
				...
				<Menu onClick={t.linkTo.bind(this)} theme="dark" {...map}>
					<Menu.Item key="home" ><Icon type="pie-chart" /><span>首页</span></Menu.Item>
					<SubMenu title={<span><Icon type="appstore" /><span >报表</span></span>}>
						<Menu.Item key="reportformA" ><span >报表A</span></Menu.Item>
						<Menu.Item key="reportformB" ><span >报表B</span></Menu.Item>
					</SubMenu>
					...
					<Menu.Item key="work" ><Icon type="pie-chart"/><span >工作</span></Menu.Item>
					<Menu.Item key="sub5" style={ {marginTop : '80px',marginBottom : '80px'} }><Icon type="pie-chart"/><span >消息</span></Menu.Item>
					<SubMenu title={<span><Icon type="appstore" /><span >设置</span></span>}>
						<Menu.Item key="personmanage"><span >员工管理</span></Menu.Item>
						<Menu.Item key="roleset"><span >角色设置</span></Menu.Item>
						<Menu.Item key="businessmanage"><span >业务对象管理</span></Menu.Item>
						<Menu.Item key="setting4"><span >公海管理</span></Menu.Item>
					</SubMenu>
					<Menu.Item key="sub7" ><Icon type="pie-chart"/><span >帮助</span></Menu.Item>
				</Menu>
			</div>
		);
	}
